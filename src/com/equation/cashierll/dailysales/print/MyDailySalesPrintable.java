...
public class MyDailySalesPrintable implements Printable {
	JTable itemsTable;
	String receiptnumber;
	double totalcost;
	String dated;

	public MyDailySalesPrintable(JTable table, String receiptnumber, double totalcost, String dated) {
	...
	public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
		...
		if (pageIndex == 0) {
			...
			try {
				...
				g2d.drawString(
						"Cashier :" + Monitor.fullname.get(Monitor.fullname.size() - 1).toUpperCase().toUpperCase(), 10,
						y + 40);

				// g2d.drawString("TOTAL $" + totalcost, 10, y + 50);
				g2d.drawString("End Of Day Report", 10, y + 50);
				g2d.drawString("Dated " + dated, 10, y + 60);
				/* Draw Colums */
				g2d.drawLine(0, y + 70, 180, y + 70);
				g2d.drawString(Header.header[0], 0, y + 80);
				g2d.drawString(Header.header[1], 80, y + 80);
				g2d.drawString(Header.header[2], 100, y + 80);
				...
				for (int i = 0; i < itemsTable.getRowCount(); i++) {
					...
					cH = (y + 90) + (10 * i); // shifting drawing line
