...
public class MyPeriodSalesPrintable implements Printable {
	JTable itemsTable;
	String receiptnumber;
	double totalcost;
	String from, to;

	public MyPeriodSalesPrintable(JTable table, String receiptnumber, double totalcost, String from, String to) {
	...
	public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
		...
		if (pageIndex == 0) {
			...
			try {
				...
				g2d.drawString("Cash Sales Report", 10, y + 60);
				g2d.drawString("Period " + from + " - " + to, 10, y + 70);
				/* Draw Colums */
				g2d.drawLine(0, y + 80, 180, y + 80);
				g2d.drawString(Header.header[0], 0, y + 90);
				g2d.drawString(Header.header[1], 80, y + 90);
