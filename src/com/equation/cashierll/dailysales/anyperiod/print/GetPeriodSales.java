...
import com.equation.cashierll.dailysales.print.Header;
...
public class GetPeriodSales {
	...
	public GetPeriodSales(ResultSet rs, ResultSet rs1, Statement stm, Statement stmt) {
		this.stm = stm;
		this.stmt = stmt;
		this.rs = rs;
		this.rs1 = rs1;
	...
	public Object[][] getData(String dateString, String dateStringto) {
	...
	public JTable getTable(String dateString, String dateStringto) {
		DefaultTableModel model = new DefaultTableModel(getData(dateString, dateStringto), Header.header);
