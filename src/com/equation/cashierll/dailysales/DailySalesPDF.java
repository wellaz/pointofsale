 ...
 * @author Wellington
 */
public class DailySalesPDF {
	String tablename = "Today's Sales Report";

	double sum;
	JTable jtable;

	public DailySalesPDF(JTable jtable, double sum) {
		this.sum = sum;
		this.jtable = jtable;
	...
	public void generatePDF() {
		try {
			...
			PdfPCell cell = new PdfPCell(new Paragraph(tablename.toUpperCase() + ". Total sales $" + sum,
