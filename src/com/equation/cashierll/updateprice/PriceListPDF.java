...
import com.equation.cashierll.dailysales.Header;
...
public class PriceListPDF {
	String tablename = "Price List";

	JTable jtable;

	public PriceListPDF(JTable jtable) {
		this.jtable = jtable;
	}
	...
	public void generatePDF() {
		try {
			...
			PdfPCell cell = new PdfPCell(new Paragraph("Price List",
