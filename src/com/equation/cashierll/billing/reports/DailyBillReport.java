...
import com.equation.cashierll.change.search.ChangePDF;
import com.equation.cashierll.change.search.Header;
...
public class DailyBillReport extends JPanel {
	...
	public DailyBillReport(ResultSet rs, ResultSet rs1, Statement stm, Statement stmt, JTabbedPane tabs, int receipt) {
		this.stm = stm;
		this.stmt = stmt;
		this.rs = rs;
		this.rs1 = rs1;
