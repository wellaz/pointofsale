...
public class BillPDF {
	String tablename = "Bill Report";

	double sum;
	JTable jtable;
	int records;

	public BillPDF(JTable jtable, double sum, int records) {
		this.sum = sum;
		this.jtable = jtable;
	...
	public void generatePDF() {
		try {
			...
			document.add(new Paragraph("Billing Report Generated",
			...
			PdfPCell cell = new PdfPCell(new Paragraph(
					tablename.toUpperCase() + ". Total bill $" + sum + ". " + CountRecords.returnRecords(records),
