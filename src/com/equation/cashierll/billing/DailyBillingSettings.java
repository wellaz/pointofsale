...
public class DailyBillingSettings {
	ResultSet rs;
	Statement stm;
	...
	public DailyBillingSettings(ResultSet rs, Statement stm) {
		this.rs = rs;
		this.stm = stm;
	 ...
	 * AccessDbase(); adbase.connectionDb(); DailyBillingSettings d = new
	 * DailyBillingSettings(adbase.rs, adbase.stm); d.makeDialog(); }
	 */
