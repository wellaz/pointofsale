...
public class AllChangePDF {
	String tablename = "Outstanding Change List";

	JTable jtable;

	public AllChangePDF(JTable jtable) {
		this.jtable = jtable;
	}
	...
	public void generatePDF() {
		try {
			...
			document.add(new Paragraph("Price List Generated",
					FontFactory.getFont(FontFactory.TIMES_ROMAN, 9, Font.ITALIC, BaseColor.BLACK)));
			document.add(new Paragraph("-----------------------------",
					FontFactory.getFont(FontFactory.TIMES_ROMAN, 9, Font.ITALIC, BaseColor.BLACK)));
			document.add(new Paragraph("Tell : ",
					FontFactory.getFont(FontFactory.TIMES_ROMAN, 9, Font.ITALIC, BaseColor.BLACK)));
			...
			PdfPCell cell = new PdfPCell(new Paragraph("Outstanding Change List",
